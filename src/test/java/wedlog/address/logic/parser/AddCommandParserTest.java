...
import static wedlog.address.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
...
public class AddCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        // missing phone
        expectedPerson = new PersonBuilder(BOB).withoutPhone().build();
        assertParseSuccess(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND
                + TAG_DESC_HUSBAND, new AddCommand(expectedPerson));
        ...
        // missing address
        expectedPerson = new PersonBuilder(BOB).withoutAddress().build();
