...
public class CommandTestUtil {
    ...
    public static void showGuestAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredGuestList(new GuestNamePredicate(Arrays.asList(splitName[0])));
    ...
    public static void showVendorAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredVendorList(new VendorNamePredicate(Arrays.asList(splitName[0])));
