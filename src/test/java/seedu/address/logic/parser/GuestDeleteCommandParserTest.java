...
public class GuestDeleteCommandParserTest {
    ...
    @Test
    public void parse_validArgs_returnsGuestDeleteCommand() {
        assertParseSuccess(parser, "1", new GuestDeleteCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, GuestDeleteCommand.MESSAGE_USAGE));
    }
}
