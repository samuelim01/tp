...
import wedlog.address.storage.AddressBookStorage;
...
import wedlog.address.storage.UserPrefsStorage;
import wedlog.address.ui.Ui;
import wedlog.address.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public static final Version VERSION = new Version(1, 1, 1, false);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting WedLog " + MainApp.VERSION);
